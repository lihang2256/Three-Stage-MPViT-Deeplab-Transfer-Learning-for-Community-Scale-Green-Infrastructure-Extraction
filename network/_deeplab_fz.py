...
class DeepLabV3Fz(_SimpleSegmentationModel):
    """
...
class DeepLabHeadV3PlusFz(nn.Module):
    def __init__(self, in_channels, low_level_channels, num_classes, aspp_dilate=[12, 24, 36]):
        super(DeepLabHeadV3PlusFz, self).__init__()
        ...
        for param in self.project[1].parameters():
...
class ASPPPooling(nn.Sequential):
    def __init__(self, in_channels, out_channels):
        ...
        for param in self[2].parameters():
            param.requires_grad = False
...
class ASPP(nn.Module):
    def __init__(self, in_channels, atrous_rates):
        ...
        for param in modules[0][1].parameters():
            param.requires_grad = False
